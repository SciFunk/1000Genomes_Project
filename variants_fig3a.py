...
pop_percents = {'ESN': 10,'GWD': 10,'LWK': 10,'MSL': 8,'YRI': 10,'ACB': 10,
              'ASW': 6,'CLM': 8,'MXL': 6,'PEL': 8,'PUR': 10,'CDX': 8,
              'CHB': 10,'CHS': 10,'JPT': 10,'KHV': 10,'CEU': 10,'GBR': 8,
              'FIN': 10,'IBS': 10,'TSI': 10,'BEB': 8,'GIH': 10,'ITU': 10,
              'PJL': 10,'STU': 10}
